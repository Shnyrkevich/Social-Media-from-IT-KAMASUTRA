...
function Header(props) {
  function logOutAction() {
    props.logOutThunkActionCreator();
  }
    ...
    <header className="app-header">
      ...
      { props.isAuth ?
          ...
          <div className="header-information">
            <p className="header-information_login">
              { props.login }
            </p>
            <p className="header-information_email">
              { props.email }
            </p>
          </div>
          <div>
          ...
          <NavLink className='app-header_sigh-in' to='/login'>SignIn</NavLink>
      }
    </header>
  );
}
